...
# Setup CSI Camera
camera = CSICamera(capture_width=1280, capture_height=720, downsample=2, capture_fps=20)
...
if len(objpoints) > 0 and len(imgpoints) > 0:
    ...
    with open("intrinsics.txt", "w") as file:
        file.write(f"{focal_length_x} {center_x} {center_y} {k1} {k2} {p1} {p2} {k3}\n")

    print("\nFocal length, principal points, and distortion coefficients saved to intrinsics.txt")
else:
